  ...
  Unavailable until {book.dueDate ? new Date(book.dueDate).toLocaleDateString('en-GB') : 'returned'}
        ...
        {user?.role === 'member' && (
          <button
            ...
            className="mt-4 w-full py-2 px-4 rounded-lg text-white bg-blue-600 hover:bg-blue-700 transition-colors duration-200"
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
            <div className="bg-white p-6 rounded shadow-md w-full max-w-xs relative">
              ...
              <div className="mb-2">
                ...
                <input type="date" value={today} disabled className="w-full border rounded px-2 py-1 bg-gray-100" />
              </div>
              <div className="mb-2">
              ...
              <div className="mb-2 text-sm">
                ...
                <span>Rent: ${rentPerDay} x {days} days = ${totalRent}</span><br />
                {extraDays > 0 && (
                  <span className="text-red-600">Extra charge for {extraDays} day(s): ${extraCharge}</span>
                )}
              </div>
